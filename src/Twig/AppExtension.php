...
class AppExtension extends AbstractExtension
{
    ...
    {
        return [
            new Twig_Filter('ExecutionTimeInHours', array($this, 'ExecutionTimeInHours')),
            new Twig_Filter('ExecutionTimeGeneric', array($this, 'ExecutionTimeGeneric')),
            new Twig_Filter('getPercentage', array($this, 'getPercentage')),
            new Twig_Filter('cast_to_array', array($this, 'cast_to_array')),
            new Twig_Filter('pre_print_r', array($this, 'pre_print_r'), array('is_safe' => array('html'))),
            new Twig_Filter('time_ago', function ($time) { return $this->ExecutionTimeInHours(time() - $time);}),
        ];
    }
