...
class UserVoter extends Voter
{
    ...
    protected function supports($attribute, $subject): bool
    {
        ...
        if (!$subject instanceof TheGameUser) {
            return false;
        }
    ...
    protected function voteOnAttribute($attribute, $subject, TokenInterface $token): bool
    {
        ...
        if (!$logedin_user instanceof TheGameUser) {
            // the user must be logged in; if not, deny access
            return false;
        }

        // you know $subject is a Post object, thanks to supports
        /** @var TheGameUser $edited_user */
        $edited_user = $subject;
    ...
    /**
     * @param TheGameUser $edited_user
     * @param TheGameUser $logedin_user
     * @return bool
     */
    private function canView(TheGameUser $edited_user, TheGameUser $logedin_user): bool
    {
...
//        }
     ...
     * @return bool
     */
    private function canEdit(TheGameUser $edited_user, TheGameUser $logedin_user): bool
    {
     ...
     * @return bool
     */
    private function canDelete(TheGameUser $edited_user, TheGameUser $logedin_user): bool
    {
        // this assumes that the data object has a getOwner() method
        // to get the entity of the user who owns this data object
        /** @var PersistentCollection $logedin_user_roles */
